...
// define constants
#define FIRST_NAME "Micah"
#define LAST_NAME "Winters"
#define WEIGHT 200.0
#define AGE 20
...
void output(void){
    ...
    // << is the insertion operator and it's used in conjuction
...
void input(){
    ...
    // >> is the extraction operator and it's used to read inut
    // from the inut stream and place it in a variable
    cin >> age;
    ...
    cin >> weight;
    cout << "Entered age is: " << weight << endl;
    ...
    // cin stops reading a sring when it encounters an empty space
    // cin >> name;
